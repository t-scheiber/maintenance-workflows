...
import {preparationIdentity,runtimeExecutionDockerEnvironment} from './prepare-runtime.mjs';
...
export function preparedScanner(scanner,{env=process.env,execute=spawnSync,nativeAdmission=admitSourceScanners,inspectArchive=archiveIdentity}={}){
 ...
 const {command,dockerEnvironment}=runtimeExecutionDockerEnvironment(directory,env);
